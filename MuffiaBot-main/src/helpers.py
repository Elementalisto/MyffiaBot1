...
async def update_registration_message(chat_id, context):
    text = game_start_message + '\nЗареєстровані гравці:' + chats[chat_id].alive_players_links()
